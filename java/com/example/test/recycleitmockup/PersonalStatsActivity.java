    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), AddDropoffActivity.class);
        ...
        score = findViewById(R.id.pstats_score_edit);
        score.setText("492");

        last_haul = findViewById(R.id.pstats_last_edit);
        last_haul.setText("37");
    }
